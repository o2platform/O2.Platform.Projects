...
namespace O2.Core.XRules.Ascx
{
    partial class ascx_XRules_Editor
    {
        ...
        private void InitializeComponent()
        {
			...
			((System.ComponentModel.ISupportInitialize)(this.scTopLevel)).BeginInit();
			this.scTopLevel.Panel1.SuspendLayout();
			this.scTopLevel.Panel2.SuspendLayout();
			this.scTopLevel.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.scRightPanel)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.scTopLevel)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.scRightPanel)).EndInit();
