...
namespace Irony.Parsing { 
  ...
  public partial class Grammar {
    ...
    public Grammar(bool caseSensitive) {
      ...
      ConsoleTitle = O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgDefaultConsoleTitle;
      ConsoleGreeting = string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgDefaultConsoleGreeting, this.GetType().Name);
      ConsolePrompt = ">"; 
    ...
    public readonly Terminal Eos = new Terminal("EOS", O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.LabelEosLabel, TokenCategory.Outline, TermFlags.IsNonScanner);
