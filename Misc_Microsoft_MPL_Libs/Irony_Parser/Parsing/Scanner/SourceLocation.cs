...
namespace Irony.Parsing {
  ...
  public struct SourceLocation {
    ...
    public override string ToString() {
      return string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.FmtRowCol, Line, Column);
    }
    //Line and Column displayed to user should be 1-based
    public string ToUiString() {
      return string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.FmtRowCol, Line + 1, Column + 1);
    }
