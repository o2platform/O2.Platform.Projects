...
namespace Irony.Parsing { 
  ...
  public partial class CoreParser {
    ...
    private void ExecuteReduce(ParserAction action) {
      ...
      Context.AddTrace(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgTracePoppedState, reduceProduction.LValue.Name);
    ...
    private void CheckCreateAstNode(ParseTreeNode parseNode) {
      try {
        ...
        Context.AddParserMessage(ParserErrorLevel.Error, parseNode.Span.Location, O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ErrFailedCreateNode, parseNode.Term.Name, ex.Message); 
      }
    }
    #endregion
    ...
    private Token CreateBraceMismatchErrorToken(Token closingBrace) {
      return new Token(_grammar.SyntaxError, closingBrace.Location, closingBrace.Text,
          string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ErrUnmatchedCloseBrace, closingBrace.Text));
    }
    #endregion
