  ...
  public class ParserAction {
    ...
    public override string ToString() {
      switch (this.ActionType) {
        case ParserActionType.Shift: return string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.LabelActionShift, NewState.Name);
        case ParserActionType.Reduce: return string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.LabelActionReduce, ReduceProduction.ToStringQuoted());
        case ParserActionType.Operator: return string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.LabelActionOp, NewState.Name, ReduceProduction.ToStringQuoted());
