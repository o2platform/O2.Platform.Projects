...
using System.Linq;
using System.Text;
using O2_Misc_Microsoft_MPL_Libs.Irony_Parser;
...
namespace Irony.Parsing { 
  public partial class CoreParser {
    ...
    private bool TryRecoverFromError() {
      ...
      Context.AddTrace(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgTraceRecovering); // *** RECOVERING - searching for state with error shift *** 
    ...
    private bool TryRecoverImpl() {
      ...
      Context.AddTrace(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgTraceRecoverFoundState, Context.CurrentParserState); 
      //2. Shift error token - execute shift action
      Context.AddTrace(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgTraceRecoverShiftError, errorShiftAction);
      ...
      Context.AddTrace(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgTraceRecoverShiftTillEnd);
      while (true) {
        ...
        if (action != null) {
          ...
          Context.AddTrace(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgTraceRecoverReducing);
          Context.AddTrace(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgTraceRecoverAction, action);
    ...
    private void ReportParseError() {
      ...
      if (Context.CurrentParserInput.Term == _grammar.Eof) {
        Context.AddParserError(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ErrUnexpEof);
        return; 
      }
      if (Context.CurrentParserInput.Term == _grammar.Indent) {
        Context.AddParserError(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ErrUnexpIndent);
        return;
      }
