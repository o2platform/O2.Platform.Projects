  ...
  public class CommandLine {
    ...
    public void Run() {
      try {
        ...
        Console.WriteLine(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ErrConsoleFatalError);
        Console.WriteLine(ex.ToString());
        Console.ForegroundColor = ConsoleColor.White;
        Console.WriteLine(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgPressAnyKeyToExit);
        Console.Read();
      }
    ...
    private ReadResult ReadInput(out string input) {
      ...
      _ctrlCPressed = false;
      if (O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ConsoleYesChars.Contains(input))
        return ReadResult.AbortYes;
      if (O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ConsoleNoChars.Contains(input))
    ...
    public virtual void OnCancelKeyPress(object sender, ConsoleCancelEventArgs e) {
      ...
      if (Interpreter.IsBusy()) {
        ...
        Console.Write(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgAbortScriptYN);
        string input;
        var result = ReadInput(out input);
        switch (result) {
        ...
        Console.WriteLine();
        Console.Write(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.MsgExitConsoleYN);
      }
    }//method
    #endregion
