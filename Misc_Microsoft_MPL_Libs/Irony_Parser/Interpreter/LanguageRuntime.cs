...
namespace Irony.Interpreter { 
  ...
  public class Unassigned {
    ...
    public Unassigned() {
        _toString = O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.LabelUnassigned;
    }
 ...
 */ 
    ...
    public virtual OperatorImplementation AddOperatorImplementation(OperatorImplementationTable implementations, OperatorDispatchKey forKey) {
      ...
      if (! _baseOperatorImplementations.TryGetValue(baseKey, out baseImpl))
        throw new Exception(string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ErrOpNotDefinedForTypes, forKey.OpSymbol, forKey.Arg1Type, forKey.Arg2Type));
    ...
    protected virtual TypeConverter GetConverter(Type fromType, Type toType) {
      ...
      string err = string.Format(O2_Misc_Microsoft_MPL_Libs.Irony_Parser.Resources.ErrCannotConvertValue, fromType, toType);
